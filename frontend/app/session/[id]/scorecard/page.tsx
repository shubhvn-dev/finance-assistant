...
import { ScorecardStream } from '@/components/ScorecardStream';
  ...
  return (
    <main className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* If scorecard exists in DB — static render */}
        {scorecard ? (
          <>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-8 mt-6">
              ...
              {scorecard.annotations && scorecard.annotations.length > 0 ? (
                <p className="text-sm text-slate-500 mb-6">
                  {scorecard.annotations.length} coaching moment{scorecard.annotations.length !== 1 ? 's' : ''} highlighted
                </p>
              ) : (
                <div className="mb-6" />
              )}
          ...
          /* No scorecard yet — stream it live */
          <ScorecardStream
            sessionId={id}
